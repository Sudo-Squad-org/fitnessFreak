...
export const ClassCard = ({ cls }) => {
  return (
    <Card className="flex flex-col h-full overflow-hidden border border-border shadow-none transition-all hover:shadow-md group">
      <div className="relative h-32 w-full bg-muted flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-muted-foreground/10 to-transparent"></div>
        <Armchair className="h-12 w-12 text-muted-foreground/30 relative z-10" />
      ...
      <CardContent className="flex-1 space-y-3 pb-4">
        ...
        <div className="pt-2 flex items-center justify-between text-xs font-medium border-t border-border">
